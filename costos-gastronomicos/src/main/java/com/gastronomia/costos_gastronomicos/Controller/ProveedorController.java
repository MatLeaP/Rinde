...
public class ProveedorController {
    ...
    public ResponseEntity<List<Proveedor>> getAllProveedorByClienteId(@PathVariable Long clienteId){

        List<Proveedor> proveedores = proveedorService.getAllProveedoresByClienteId(clienteId);
